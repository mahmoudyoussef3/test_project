...
class PauseOrdersNotifier extends StateNotifier<PauseOrdersState> {
  final OrdersFacade _ordersRepository;
  int _page = 0;
  bool _hasMore = true;

  PauseOrdersNotifier(this._ordersRepository)
      : super(const PauseOrdersState());

  Future<void> fetchPauseOrders({
