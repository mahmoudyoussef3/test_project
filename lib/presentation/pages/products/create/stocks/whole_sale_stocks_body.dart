...
class CreateWholeSaleStocksBody extends ConsumerStatefulWidget {
  final VoidCallback onNext;

  const CreateWholeSaleStocksBody({super.key, required this.onNext});

  @override
  ConsumerState<CreateWholeSaleStocksBody> createState() =>
      _CreateWholeSaleStocksBodyState();
}

class _CreateWholeSaleStocksBodyState
    extends ConsumerState<CreateWholeSaleStocksBody> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => ref.read(wholeSaleProvider.notifier).setInitialStocks(
            product: ref.read(createFoodDetailsProvider).createdProduct,
          ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final next = ref.watch(createFoodStocksProvider).groups.any((element) =>
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () {
                      if (state.formKeys.every((element) =>
                        ...
                        final product =
                            ref.read(createFoodDetailsProvider).createdProduct;
